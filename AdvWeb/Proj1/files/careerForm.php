 ...
 <header>         
    ...
    <aside>
            <div id="mySideNav" class="sideNav">
                    ...
                    <a href="#">COURSES</a>
                    <a href="#">ADMISSION</a>
                    <a href="./applyForm.php">APPLY NOW</a>
                    <a href="./careerForm.php" id="now">CAREER</a>
                    <a href="#">ABOUT US</a>
                </div>  
    </aside>
...
<!-- Added Small Design -->
	...
	<form action="./CareerDBStore.php" method="POST">
		...
		<tr>
			<td>
				<fieldset>
					<legend><label for="teachExp">Teaching Exprience</label></legend>
					<select name="teachExp" id="teachExp">
						<option value=""></option>
